    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            buttons = InlineKeyboardMarkup(
                ...
                [[InlineKeyboardButton(text="🎉 Tambahkan saya ke grup", url="https://t.me/YasirGroupManagerBot?startgroup=new")],
                ...
                [InlineKeyboardButton(text="❓ Bantuan", url="https://t.me/YasirGroupManagerBot?start=help"), InlineKeyboardButton(text="💖 Donasi", url="http://ayrahikari.github.io/donations.html")]])
